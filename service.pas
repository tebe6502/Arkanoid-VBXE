...
type
   ...
   BALLTYPE = RECORD                   { contiene i dati della pallina }
              ...
              speed  : integer;        { velocita' (256 = 70 pixel al sec. }
              finespeed : integer;     { velocita' (sottomultiplo) }
...
procedure shine(xb,yb : smallint);   { questa procedura imposta lo }
...
procedure set_ball_speed(var ball : BALLTYPE; speed : integer);
var
  sx,sy : integer;  { imposta la velocita' della palla in base al modulo }
...
procedure remove_block(xa,ya : smallint);
var
    x,y,
    xs,ys : word;
    yh,cl : smallint;
...
procedure place_block(xa,ya,block : smallint);
var
    x,y,
    xs,ys : word;
    cl,cl2: smallint;
...
function split_line(var x1,y1,x2,y2 : smallint) : smallint;
var
    x,y,
    xk,yk,
    xj,yj,
